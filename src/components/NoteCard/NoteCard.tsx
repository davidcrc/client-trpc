...
const NoteCard = ({ note }: NoteCradProps) => {
  ...
  return (
    <div className="flex flex-col gap-4 bg-zinc-800 px-6 py-2 mb-3">
      ...
      <div className="flex gap-2">
        <button
          className="bg-red-500 rounded px-3 py-2 text-white ml-auto"
        ...
        <button
          className={`${
            note.done ? "bg-green-400" : "bg-red-300"
          } rounded px-2 py-1`}
          onClick={handleTogleDoneNote}
        >
          Done
        </button>
      </div>
